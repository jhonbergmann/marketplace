...
export type SecondaryAppNavigatorRoutesProps = BottomTabNavigationProp<SecondaryAppRoutes>
...
export const SecondaryAppRoutes = () => {
  ...
  return (
    ...
    >
      ...
      <Screen name="myads" component={MyAds} options={{tabBarIcon: ({color}) => <AdsSvg fill={color} stroke={color} width={iconSize} height={iconSize} />}} />
      <Screen
        name="getout"
        component={() => {
        ...
        options={{tabBarIcon: ({color}) => <GetOutSvg fill={color} width={iconSize} height={iconSize} />}}
      />
    </Navigator>
  )
}
